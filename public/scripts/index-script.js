...
function change_to_en(){
    ...
    document.getElementById('txtDescRecentProjects').innerHTML = "I started my projects on May 3, 2020, with the intention of learning and being able to disseminate my work and my learning, I am currently focusing on mobile development but I have knowledge in Windows Forms, ASP .NET MVC, JAVA, NODE JS, HTML, CSS and JS"
...
function change_to_ptbr(){
    ...
    document.getElementById('txtMobileDeveloper').innerHTML = "Desenvolvimento"
    document.getElementById('txtDescRecentProjects').innerHTML = "Iniciei meus projetos no dia 3 de maio de 2020, com o intuito de aprender e poder divulgar meu trabalho e meu aprendizado, atualmente estou focando em desenvolvimento mobile mas tenho conhecimentos em Windows Forms, ASP .NET MVC, JAVA, NODE JS, HTML, CSS and JS"
